...
export async function POST(request: Request) {
  try {
    ...
    const mailOptions = {
      from: 'admin@SaudaraVoucher.com',
      to,
      subject: 'Purchase Confirmation - SaudaraVoucher',
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="text-align: center; margin-bottom: 30px;">
            <img src="https://SaudaraVoucher.com/app_icon.png" alt="SaudaraVoucher Logo" style="width: 150px; height: auto; margin-bottom: 20px;">
          </div>
