...
export const metadata: Metadata = {
  title: 'Privacy Policy - SaudaraVoucher',
  description: 'Privacy Policy for SaudaraVoucher game voucher and top-up services',
}
          ...
          <section className="space-y-8">
            <div>
              ...
              <p className="text-gray-600">
                SaudaraVoucher collects personal information including but not limited to: name, email address, phone number, game account details, player IDs, payment information, and transaction history when you purchase game vouchers, top-up credits, or create an account on our platform.
              </p>
            </div>
